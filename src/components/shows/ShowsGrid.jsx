...
const ShowsGrid = ({ shows }) => {
  ...
  return <div>{ 
    shows.map((data)=>(<ShowCard key={data.show.id} id={data.show.id} name={data.show.name} image={data.show.image ? data.show.image.medium : "/NotFound.png"} summary={data.show.summary} onStarMeClick={onStarMeClick}/>))
    }</div>;
};
